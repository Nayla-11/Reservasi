            ...
            if($data['status'] == 'DISETUJUI') {
                if(
                    ...
                    if($item->update($data)) {
                        ...
                        dispatch(new SendEmail($user_email, $user_name, $item->room->name, $item['date'], $item['start_time'], $item['end_time'], $item['purpose'], $item['tools'], $to_role, $user_name, 'https://google.com', $data['status']));

                        $to_role    = 'ADMIN';

                        // URL::to('/admin/booking-list)
                        dispatch(new SendEmail($admin_email, $user_name, $item->room->name, $item['date'], $item['start_time'], $item['end_time'], $item['purpose'], $item['tools'], $to_role, $admin_name, 'https://google.com', $data['status']));
